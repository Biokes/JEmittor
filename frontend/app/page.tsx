...
export default function Home() {
    ...
    const registerEndpoint = `http://localhost:8001/realms/Jemittor/protocol/openid-connect/registrations?client_id=jemittor-frontend&response_type=code&scope=openid&redirect_uri=http://localhost:3000/home`;
    const loginEndpoint = `http://localhost:8001/realms/Jemittor/protocol/openid-connect/auth?client_id=jemittor-frontend&response_type=code&scope=openid&redirect_uri=http://localhost:3000/home`;
            ...
            <nav className="fixed top-0 w-full z-50 bg-surface/80 dark:bg-surface-dark/80 backdrop-blur-xl transition-all h-20 border-b border-outline-variant/10">
                <div className="flex justify-between items-center max-w-7xl mx-auto px-6 h-full">
                    ...
                    <div className="flex items-center gap-6">
                        ...
                        <a href={loginEndpoint} className="text-slate-600 dark:text-slate-400 font-semibold text-sm hover:opacity-80 transition-opacity">Signin</a>
                        <a href={registerEndpoint} className="bg-primary-container text-white px-6 py-2.5 rounded-xl font-semibold text-sm hover:brightness-110 active:scale-95 transition-all duration-200">Signup</a>
                    </div>
                </div>
            </nav>
                    ...
                    <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-16 items-center relative z-10">
                        <div className="space-y-8 animate-fade-in-up">
                            ...
                            <p className="text-lg text-on-surface-variant dark:text-slate-400 max-w-lg leading-relaxed">
                                Define rules for crypto and FX. Get notified instantly when they hit. Architecture built for sub-millisecond precision.
                            </p>
                            <div className="flex flex-wrap gap-4 pt-4">
                                <a
                                    href={registerEndpoint}
                                    className="text-on-surface dark:text-white px-8 cursor-pointer py-4 bg-primary/70 text-white rounded-xl font-bold text-lg shadow-xl shadow-primary/20 hover:scale-105 active:scale-95 transition-all"
                                >
                                    Start for Free
                                </a>
                    ...
                    <div className="max-w-7xl mx-auto px-6">
                        ...
                        <div className="grid md:grid-cols-3 gap-8">
                            <div className="reveal-on-scroll stagger-delay-1 p-10 rounded-3xl bg-surface-container-low dark:bg-surface-container-dark hover:bg-surface-container dark:hover:bg-surface-container-highest transition-all group hover:-translate-y-2">
                                ...
                                <p className="text-on-surface-variant dark:text-slate-400 leading-relaxed">Direct integration with major Blockchain and FX streams for zero-latency data ingest.</p>
                            </div>
                                ...
                                <div className="space-y-12">
                                    ...
                                    <div className="flex gap-6 group">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-on-surface-variant dark:text-slate-400">Our infrastructure ensures instant delivery of alerts to your chosen device.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div className="max-w-5xl mx-auto px-6 reveal-on-scroll">
                        <div className="bg-primary-container rounded-[2rem] p-12 text-center text-white relative overflow-hidden group">
                            ...
                            <div className="relative z-10">
                                ...
                                <button onClick={() => {
                                    router.push("http://localhost:8001/realms/Jemittor/protocol/openid-connect/auth?client_id=Jemittor-frontend&response_type=code&scope=openid&redirect_uri=http://localhost:3000/home&kc_action=register")
                                }} className="bg-white text-primary px-10 py-4 rounded-xl font-bold text-lg hover:bg-surface-container-low transition-all duration-400 active:scale-95 shadow-xl">Get Started Now</button>
                            </div>
                        </div>
                    </div>
                </section>
